      ...
      <!-- TABELA -->
          <div class="container-fluid">
            ...
            <tbody>
              ...
              $this->session->set_userdata('proc_id',$instrucoes[0]->proc_id);
              ?>
            </tbody>
            </table>
          </div>
                ...
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-sm-2 form-group">
                      <input class="form-control" id="proc_id" name="proc_id"  type="number" placeholder="<?php echo $instrucoes[0]->proc_id ?>" value="<?php $instrucoes[0]->proc_id ?>" disabled>
                    </div>
